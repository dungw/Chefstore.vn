...
class module_product extends Module{
    ...
    function draw(){
        ...
        $min = CInput::get('min','int',0);
        $max = CInput::get('max','int',0);
        if ($min>=0 && $max>0) {
        ...
        if ($type=='new' || $type=='discount' || $type=='bestsell' || $type=='search' || $type=='saleoff') {
            ...
            switch ($type){
                ...
                case "search":
                    ...
                    if($keyword!="" && strtolower($keyword) != "tìm kiếm trên vattunhanh.com"){
            ...
            if (count($list_product) > 0 && $list_product) {
                ...
                $html_cateogry_info = '<h1 class="cate-name"><a href="javascript:void(0)">'. $type_name .'</a></h1>';
            ...
            $html_cateogry_info .= 
                    '<div class="path-navi">
                     ...
                     <h1 class="cate-name"><a href="'.$category_link.'">'.$category_name.'</a></h1>'; 
