...
class miniCategoryNew extends Base{
    var $pk = 'id';
	var $pk_auto = true;//Primary key auto increment
	var $fields = array("id","parent_id","name"); //fields in table (excluding Primary Key)	
	var $table = "tbl_news_category";
