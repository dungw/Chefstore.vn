...
function Datepick() {
	...
	this.regional[''] = { // Default regional settings
		...
		clearStatus: 'Hủy', // Status text for clear link
		...
		prevBigStatus: 'Năm trước', // Status text for previous year link
		nextText: 'Sau&#x3e;', // Display text for next month link
		nextStatus: 'Show the next month', // Status text for next month link
		nextBigText: '&#x3e;&#x3e;', // Display text for next year link
		nextBigStatus: 'Năm sau', // Status text for next year link
        ...
        'Bảy','Tám','Chín','Mười','M.Một','M.Hai'], // For formatting
		monthStatus: 'Chọn tháng khác', // Status text for selecting a month
		yearStatus: 'Chọn năm khác', // Status text for selecting a year
		...
		dayNamesShort: ['C.nhật','Hai','Ba','Tư','Năm','Sáu','Bảy'], // For formatting
		dayNamesMin: ['CN','T2','T3','T4','T5','T6','T7'], // Column headings for days starting at Sunday
		dayStatus: 'Ngày đầu tiên trong tuần là DD', // Status text for the day of the week selection
		dateStatus: '\'Chọn\' D, M d', // Status text for the date selection
		dateFormat: 'dd/mm/yy', // See format options on parseDate
		firstDay: 1, // The first day of the week, Sun = 0, Mon = 1, ...
		initStatus: 'Chọn ngày', // Initial Status text on opening
