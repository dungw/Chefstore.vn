...
--
-- Host: localhost
-- Generation Time: Jun 23, 2015 at 01:45 AM
...
(1, 6, 'Vật dụng nhà bếp', '', 1, 0, 1, 1000, '', '', '', ''),
(2, 6, 'Thiết bị bếp', '', 1, 0, 1, 900, NULL, '', NULL, NULL),
(3, 3, 'Vật Dụng Phòng Ăn', '', 1, 0, 0, 800, '', '', '', ''),
(4, 6, 'Phòng ăn', '', 1, 0, 1, 700, '', '', '', ''),
(5, 6, 'Quầy bar', '', 1, 0, 1, 600, '', '', '', ''),
...
(6, 0, 'Thiết bị nhà hàng', '', 1, 0, 1, 0, 'Thiết bị dành cho nhà hàng', '', NULL, NULL),
